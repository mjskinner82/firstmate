...
- **Optional Mercury ingress** - admit allowlisted, signed Mercury engineering assignments into a restart-safe explicit lifecycle while keeping relayed captain claims untrusted and higher-risk boundaries under direct captain control; [configuration](docs/configuration.md#dual-principal-authority-configprincipal-authorityjson) owns setup and supported limits.
...
- [docs/configuration.md](docs/configuration.md) - environment variables, `FM_HOME`, runtime backend selection, optional Mercury authority and Relay setup, the files you set, and harness support.
