...
family_for_basename() {
  case "$1" in
    ...
    fm-documentation-audiences.test.sh|fm-ensure-agents-md.test.sh|fm-git-lib.test.sh|fm-path-lib.test.sh|fm-grok-harness.test.sh|\
    ...
    fm-github-feedback-intake.test.sh|fm-gotmp.test.sh|\
...
tests/fm-github-feedback-intake.test.sh 2000
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-github-feedback-intake.sh|\
